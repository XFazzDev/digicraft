...
export default function DivisiPage() {
  const logo = "https://akcdn.detik.net.id/community/media/visual/2025/06/29/melihat-lebih-dekat-sekolah-rakyat-di-sentra-handayani-jaktim-1751179722558_169.jpeg?w=700&q=90";

  return (
    <>
      <Head>
        <title>Halaman Divisi | Digicraft</title>
      </Head>

      {/* Landing Section with Background Image */}
      <section
        className="relative h-screen w-full bg-cover bg-center"
        style={{ backgroundImage: `url(${logo})` }} // gunakan template literal
      >
        {/* Overlay */}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 text-white">
          <h1 className="text-5xl font-bold text-yellow-400 drop-shadow-lg">
            Halaman <span className="text-white">{'{Divisi}'}</span>
          </h1>
          <p className="mt-4 text-lg text-gray-300 max-w-xl">
            Jelajahi peran, visi, misi, dan anggota dari setiap divisi Digicraft yang membentuk masa depan digital.
          </p>
      ...
      <section className="bg-gradient-to-br from-black via-[#0f0f0f] to-[#1a1a1a] text-white px-6 py-20 space-y-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-yellow-400 border-b border-yellow-400 pb-2 mb-4">Visi</h2>
          <p className="text-lg text-gray-300">
            Menjadi wadah pengembangan keterampilan digital yang inovatif dan berkelanjutan bagi pelajar Indonesia,
            serta mendorong kolaborasi kreatif yang berdampak positif bagi komunitas.
          </p>
        </div>

        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-yellow-400 border-b border-yellow-400 pb-2 mb-4">Misi</h2>
        ...
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-yellow-400 border-b border-yellow-400 pb-2 mb-4">Anggota Divisi</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-[#1a1a1a] p-6 rounded-lg shadow-md hover:shadow-yellow-500/20 transition"
              >
        ...
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-semibold text-yellow-400 border-b border-yellow-400 pb-2 mb-4">Tujuan Divisi</h2>
          <ul className="list-disc list-inside space-y-2 text-gray-300 text-lg">
