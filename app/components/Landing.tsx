      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-between min-h-screen px-6 sm:px-10 md:px-20 py-12 gap-10">
        ...
        <div className="max-w-2xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center md:justify-start">
            ...
            <button className="border-2 border-white/50 backdrop-blur-xs hover:scale-110 hover:cursor-pointer text-slate-100 font-semibold py-4 px-10 sm:px-12 rounded-xl transition-all duration-300 text-lg sm:text-base">Read More!</button>
          </div>
        </div>
